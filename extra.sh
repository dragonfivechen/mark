...
# 2. Annyoo2021
ql repo https://github.com/Annyoo2021/scripts.git "jd_|jx_|getJDCookie" "activity|backUp|Coupon|jd_try|format_" "^jd[^_]|USER"

# 3. zero205
ql repo https://github.com/zero205/JD_tencent_scf.git "jd_|jx_|getJDCookie" "activity|backUp" "^jd[^_]|USER"
